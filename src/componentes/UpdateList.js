...
function UpdateList(props) {
    ...
    onClick={(e)=>props.getList(e,props.elementId)}>Atualiza</button>
          ...
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <span className="modal-title" id="exampleModalLabel">Modificar Registro de Aluno</span>
              ...
              <div className="modal-footer">
                ...
                <button type="button"
                 ...
                 data-dismiss="modal"
                 onClick={(event)=>props.updateList(event,props.elementId)}>Atualiza</button>
              </div>
            </div>
          </div>
        </div>
